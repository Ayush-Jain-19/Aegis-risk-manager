...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors duration-150 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-wire text-canvas hover:bg-wire/90",
        secondary:
          "bg-surface-raised text-ink border border-hairline-strong hover:bg-surface-raised/70",
        outline:
        ...
        destructive: "bg-signal-block text-canvas hover:bg-signal-block/90",
        link: "text-wire underline-offset-4 hover:underline",
      },
      size: {
